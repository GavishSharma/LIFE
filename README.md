...
The system consists of multiple 3D-printed differential-drive robots operating inside a controlled arena. Instead of relying on onboard localization sensors, robot positions and orientations are estimated using an overhead camera and ArUco markers. A Jetson Orin Nano acts as the central controller, continuously tracking the robots and issuing navigation commands over Wi-Fi.
